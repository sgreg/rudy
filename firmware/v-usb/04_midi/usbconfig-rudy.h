...
// comment out to not have one
#define RUDY_SERIAL_NUMBER 'M', 'I', 'D', 'I', ' ', 'E', 'x', 'a', 'm', 'p', 'l', 'e'
#define RUDY_SERIAL_NUMBER_LEN 12

#define RUDY_DEVICE_CLASS 0x00
#define RUDY_DEVICE_SUBCLASS 0x00

#define RUDY_INTERFACE_CLASS     1 /* Audio class */
#define RUDY_INTERFACE_SUBCLASS  3 /* MIDI streaming */
...
#define RUDY_DESCR_PROPS_DEVICE                  USB_PROP_IS_DYNAMIC
#define RUDY_DESCR_PROPS_CONFIGURATION           USB_PROP_IS_DYNAMIC
